...
public class MahasiswaController {
    ...
    public void updateMahasiswa() {
        Mahasiswa mahasiswa = new Mahasiswa();
        mahasiswa.setIdMahasiswa(this.mahasiswaView.getIdMahasiswa().getText());
        mahasiswa.setNamaMahasiswa(this.mahasiswaView.getNamaMahasiswa().getText());
        mahasiswa.setJenisMahasiswa(JenisMahasiswa.valueOf(this.mahasiswaView.getJenisMahasiswa().getText()));
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");

        try {
            mahasiswa.setTanggalKadaluarsa(dateFormat.parse(this.mahasiswaView.getTanggalKadaluarsa().getText()));
    ...
    public void deleteMahasiswa() {
        if (this.mahasiswaView.getIdMahasiswa().getText() == null) {
